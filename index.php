...
<body class="h-screen w-screen overflow-hidden font-extralight flex flex-col justify-center items-center bg-gray-900">
    ...
    if(isset($_SESSION['user_id'])){ ?>
        ...
        <div class="min-h-full w-full bg-gray-400">
                        ...
                        <div class="grid grid-cols-1 gap-4 lg:col-span-2 h-full">
                            <section aria-labelledby="section-1-title" >
                                ...
                                <div class="overflow-hidden rounded-lg bg-white shadow">
                                    <div class="p-6">
                                        <div class="">
                                            <div class="inline-block min-w-full py-2 align-middle h-96 overflow-y-scroll">
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <section aria-labelledby="section-2-title">
                                ...
                                <div class="overflow-hidden rounded-lg bg-white shadow">
                                    <div class="p-6">
                                        <div>
                                            <label for="assocation" class="block text-sm font-medium leading-6 text-gray-900">Owner</label>
                                            <select id="assocation" name="location" class="mt-2 block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-gray-900 ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                                <?php
                                                    ...
                                                    $result = mysqli_query($conn, $sql);
                                                    while($row = mysqli_fetch_assoc($result)){
                                                        echo "<option value='".$row['associationid']."'>".strtolower($row['name'])."</option>";
                                                    }
                                                ?>
                                            </select>
                                        </div>
            ...
            <footer>
                <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                    <div class="border-t border-gray-200 py-8 text-center text-sm text-gray-200 sm:text-left"><span class="block sm:inline">&copy; 2021 Your Company, Inc.</span> <span class="block sm:inline">All rights reserved.</span></div>
                </div>
            </footer>
        </div>
    <?php }else{ ?>
