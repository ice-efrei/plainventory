<header class="bg-gray-900 pb-24 w-full">
    <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <div class="relative flex items-center justify-center py-5 lg:justify-between">
            <!-- Logo -->
            <div class="absolute left-0 flex-shrink-0 lg:static">
                <a href="./index.php">
                    <span class="sr-only">Lowcaltech</span>
                    <svg class="h-8 w-8" viewBox="0 0 75 75" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="relative ml-4 flex-shrink-0">
                    <div>
                        <button type="button" class="relative flex rounded-full bg-white text-sm ring-2 ring-white ring-opacity-20 focus:outline-none focus:ring-opacity-100" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                            ...
                            <minidenticon-svg username="<?php echo $_SESSION['username']; ?>" class="h-8 w-8 rounded-full"></minidenticon-svg>
                        </button>
                    </div>
                    ...
                    -->
                    <div id="user-menu" class="transform transform opacity-0 scale-95 transition ease-in duration-75 absolute -right-2 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                        <!-- Active: "bg-gray-100", Not Active: "" -->
                        <a href="./profile.php" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Profile</a>
                        <!-- Active: "bg-gray-100", Not Active: "" -->
            ...
            <div class="grid grid-cols-3 items-center gap-8">
                <div class="col-span-2">
                    <nav class="flex space-x-4">
                        ...
                        <a href="./index.php" class="text-white rounded-md bg-white bg-opacity-0 px-3 py-2 text-sm font-medium hover:bg-opacity-10" aria-current="page">Home</a>
                        <a href="./spools.php" class="text-indigo-100 rounded-md bg-white bg-opacity-0 px-3 py-2 text-sm font-medium hover:bg-opacity-10">Spool Inventory</a>
                    </nav>
                </div>
                <div>
    ...
    <div class="lg:hidden">
        <!--
          ...
          Leaving: "duration-150 ease-in"
            ...
            To: "opacity-0"
        -->
        <div class="duration-150 ease-out opacity-0 fixed inset-0 z-20 bg-black bg-opacity-25" aria-hidden="true"></div>
        ...
        -->
        <div id="mobile-menu" class="duration-150 ease-out opacity-0 scale-95 absolute inset-x-0 top-0 z-30 mx-auto w-full max-w-3xl origin-top transform p-2 transition">
            <div class="divide-y divide-gray-200 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                <div class="pb-2 pt-3">
                    <div class="flex items-center justify-between px-4">
                        ...
                        <div class="-mr-2">
                            <button id="mobile-menu-button" type="button" class="relative inline-flex items-center justify-center rounded-md bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
                                <span class="absolute -inset-0.5"></span>
                    ...
                    <div class="mt-3 space-y-1 px-2">
                        <a href="./index.php" class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-100 hover:text-gray-800">Home</a>
                        <a href="./spools" class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-100 hover:text-gray-800">Spool Inventory</a>
                    </div>
                </div>
                <div class="pb-2 pt-4">
                    ...
                    <div class="mt-3 space-y-1 px-2">
                        <a href="./profile.php" class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-100 hover:text-gray-800">Profile</a>
                        <a href="./user/logout.php" class="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-100 hover:text-gray-800">Sign out</a>
                    </div>
                </div>
            </div>
        </div>
